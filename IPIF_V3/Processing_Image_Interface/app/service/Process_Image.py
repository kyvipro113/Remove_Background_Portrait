...
def processImage(data_if: Data_Info_Model, num_processes: int):
    ...
    try:
        ...
        if(total_data < num_processes):
            ...
            process_remove_background_image(data_path=data_path, img_size_inp=img_size_inp, lImage=os.listdir(data_path), data_out_path=data_out_path, name_logger_sub_process="MainProcess")
...
def load_img_config(img_size_inp: str, omp_num_threads: int):
